    ...
    <div className="md:px-20 px-5 2xl:px-52 mt-20 md:mt-5">
      <div className="w-full ">
        ...
        <div className="flex justify-center text-center md:px-10 xl:px-20 lg:px-10 ">
          <div className="2xl:h-[50vw] lg:h-[56vw] h-screen md:h-[65vw] xl:h-[31vw] overflow-auto rounded-t-aboutBorderRadius shadow-2xl bg-white md:px-10 lg:px-5 px-5 md:pt-2 pt-5 xl:pt-5 lg:w-5/6 w-4/5 md:w-full pb-8">
