...
const About = () => {
  return (
    <div className="fixed inset-0 xl:px-16 lg:px-10 md:px-5 w-full mt-20">
      <div className="px-5 py-2">
        <p className="text-aboutTitle font-impact xl:text-7xl lg:text-5xl md:text-3xl text-xl font-normal text-center">
          Tanvir Hossain Khan
        </p>
      </div>
      <div className="flex justify-center text-center md:px-24 lg:px-10 lg:mt-10 mt-5 h-[30vw]">
        <div className=" overflow-auto rounded-t-aboutBorderRadius shadow-2xl bg-white md:px-10 lg:px-5 px-5 md:pt-5 pt-8 xl:pt-10 lg:w-5/6 w-4/5 md:w-full md:h-screen min-h-screen pb-44">
