  ...
  return (
    <div className="text-center mt-about md:mt-0">
      <div className="xl:pt-20 xl:pb-5 pt-24 2xl:pt-48 2xl:pb-10 text-center">
        <p className="text-aboutTitle tracking-custom text-2xl sm:text-4xl 2xl:text-5xl md:text-5xl lg:text-3xl font-impact font-black">Tanvir Hossain Khan</p>
      </div>
      <div className="bg-white rounded-t-aboutBorderRadius lg:pb-16 2xl:pb-about py-5 2xl:px-[8rem] sm:px-10 shadow-lg">
