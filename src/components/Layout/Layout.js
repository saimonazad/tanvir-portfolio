              ...
              {<div className="">
                      <div className="h-screen">
                          <div className={`${switchPage === "about" ? "hidden" : "block lg:px-28 lg:py-3 absolute top-5% mt-2 lg:mt-0 w-full md:relative"} `}>
                            <h1
                              className={` lg:text-3xl tracking-widest flex items-center justify-center lg:justify-start text-lg font-impact font-black text-heroTitle  md:z-50 px-2 md:px-2 uppercase lg:bg-inherit bg-white w-full  md:text-left text-center lg:py-5 py-7`}
                            >
                              {switchPage}
                            </h1>
                          </div>
                          <div className={`lg:h-5/6 h-fit flex items-center justify-start lg:px-28 px-5 gap-5 2xl:max-w-4/5 mx-auto`} >
                              ...
                              <div className={`${switchPage == 'contribution' ||switchPage == 'contact' ? 'xl:px-0 lg:px-16 px-5' : 'xl:px-48 lg:px-20 px-5'} `}>
